/**
 * @(#)ITextDocumentURIDAO.java    1.0.0 21:50:50
 *
...
/**
 * <p>Data access object for {@link ITextDocumentURIEntity}</p>
...
public interface ITextDocumentURIDAO extends GenericDao {
	...
	public static final String BEAN_NAME = "iTextDocumentURIDAO";
	 ...
	 * creating new entity;
	 * @param processDefinition TODO
	 * @param processDefinitionName TODO
	 ...
	 * @param clazz is type of entity or it's derivative, 
	 * not <code>null</code> when creating new entity;
	 * @param bundleURI TODO
	 * @param repositoryURI TODO
	 * @param processDefinition TODO
	 * @param processDefinitionName TODO
	 * @return created/updated entity or <code>null</code> on failure;
	 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
	...
	/**
	 *
	 * @param id is {@link ITextDocumentURIEntity#getId()}, not <code>null</code>.
	 * @return {@link ITextDocumentURIEntity} by given id or <code>null</code>
	 * on failure.
	 ...
	 * @author <a href="mailto:martynas@idega.com">Martynas Stakė</a>
	 */
	<T extends ITextDocumentURIEntity> T findById(Long id, Class<T> clazz);
	
	/**
	 *
	 * @return all {@link ITextDocumentURIEntity}s, existing in database.
	 * @author <a href="mailto:martynas@idega.com">Martynas Stakė</a>
	 */
	 ...
	 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
	 */
	ITextDocumentURIEntity findByProcessDefinition(
			Long processDefinition);
	 ...
	 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
	 */
	<T extends ITextDocumentURIEntity> T findByProcessDefinition(
